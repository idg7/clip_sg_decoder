...
from models import Generator, RealNVP, get_psp, CLIPInversionGenerator
...
if __name__ == '__main__':
    ...
    with mlflow.start_run():
        ...
        decoder = CLIPInversionGenerator(autoencoder, mappers, transforms.Resize((256, 256)), opts.test_with_random_z)
